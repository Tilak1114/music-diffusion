...
class UNet2DConditionModelMusic(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
    ...
    def __init__(
        ...
        elif mid_block_type == "UNetMidBlock2DCrossAttnMusic":
    ...
    def forward(
        ...
        if beat_attention_mask is not None: #Nic Modified
            ...
            if beat_attention_mask.dtype is torch.bool:
                beat_attention_mask = (1 - beat_attention_mask.to(sample.dtype)) * -10000.0
        ...
        if chord_attention_mask is not None: #Nic Modified
            ...
            if chord_attention_mask.dtype is torch.bool:
                chord_attention_mask = (1 - chord_attention_mask.to(sample.dtype)) * -10000.0
